...
def aplicar_modificacion():
    ...
    for x in range(len(codigo)):
        if codigo[x] == modificar:
            ...
            print("Platillo modificado exitosamente.")
            break
    else:
...
def mostrar_menu():  
    ...
    print("5. Modificar Platillo")  # Opción de modificar
    print("6. Borrar Insumo")  # Opción de borrar insumo
    print("7. Salir")  # Opción de salir
    ...
    while True:
        ...
        try:
            ...
            if opcion == 1:
                ...
                borrar_insumo()  # Función para borrar insumo
            elif opcion == 7:
                print("Saliendo del sistema...")
...
if __name__ == "__main__":
    main()# Menu, las funciones del menu no funcionan por que estan en construccion de codigo
def incluir_insumo():  
    print("Opción en construcción")
